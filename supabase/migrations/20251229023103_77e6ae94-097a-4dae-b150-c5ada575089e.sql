-- Create daily cron job for subscription notifications at 9 AM UTC
SELECT cron.schedule(
  'subscription-notifications-daily',
  '0 9 * * *',
  $$
  SELECT
    net.http_post(
        url:='https://qpufyeeqosvgipslwday.supabase.co/functions/v1/subscription-notifications',
        ...
        body:='{"type": "check-expiring-all"}'::jsonb
    ) as request_id;
  $$
);